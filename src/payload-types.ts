...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "largeImageBlock".
 */
export interface LargeImageBlock {
  type: 'default' | 'boxedText';
  content?: {
    root: {
      type: string;
      children: {
...
export interface PopUp {
  ...
  links?:
    ...
    | null;
  /**
   * When multiple popups are active the one with the lowest priority is shown.
   */
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        buttonGroup?: T | ButtonBlockSelect<T>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "largeImageBlock_select".
 */
export interface LargeImageBlockSelect<T extends boolean = true> {
  type?: T;
  content?: T;
  backgroundImage?: T;
  links?:
 ...
 * via the `definition` "events_select".
 */
export interface EventsSelect1<T extends boolean = true> {
  title?: T;
  location?: T;
  startDate?: T;
  allDayEvent?: T;
